    ...
    <footer className="bg-brand-navy text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Store Info */}
          <div>
            <h2 className="text-xl font-bold mb-4">Ella Xpress</h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-300 hover:text-brand-red transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-300 hover:text-brand-red transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-300 hover:text-brand-red transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-brand-red transition-colors">
                  Contact
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-white p-2 rounded flex items-center justify-center">
                <img src="https://cdn-icons-png.flaticon.com/512/5968/5968144.png" alt="Apple Pay" className="h-8" />
              </div>
              <div className="bg-white p-2 rounded flex items-center justify-center">
                <img src="https://cdn-icons-png.flaticon.com/512/5968/5968220.png" alt="Google Pay" className="h-8" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-gray-700">
          <p className="text-sm text-gray-300 text-center">
            &copy; {new Date().getFullYear()} Ella Xpress Store. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
